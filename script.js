...
(() => {
  ...
  const I18N = {
    en: {
      ...
      'hero.pill': '💼 Backend Developer • AI Engineer • Data Engineer • CTO',
      'services.title': 'Services I Offer',
      'services.desc': 'From backend systems and data pipelines to AI agents and intelligent automation — pick the engagement that fits your project.',

      'svc.backend.t': 'Backend Developer',
      'svc.backend.d': 'High-performance REST APIs, Microservices, and MVC backends built in Java & Spring Boot. Security, performance, and clean code from day one.',
      'svc.ai.t': 'AI Agents',
      'svc.ai.d': 'Custom AI agents that handle customer support, sales follow-ups, internal ops, and document processing — built on Claude / OpenAI with n8n orchestration.',
      'svc.ml.t': 'Machine Learning',
      'svc.ml.d': 'Train, evaluate, and deploy machine learning models for prediction, classification, recommendation, and anomaly detection — productionised with proper MLOps.',
      'svc.dl.t': 'Deep Learning',
      'svc.dl.d': 'Deep learning solutions: neural networks, computer vision, NLP, and transformer-based models. From PoC to production-grade inference services.',
      'svc.de.t': 'Data Engineer',
      'svc.de.d': 'End-to-end data engineering: ingestion, ETL pipelines, data modelling, warehousing, and reliable data integration between SQL Server, NoSQL, and SaaS systems.',
      'svc.da.t': 'Data Analysis',
      'svc.da.d': 'Data analysis & business intelligence: turn raw data into actionable insights with SQL, Python, and dashboards. KPIs, cohort analysis, and reporting automation.',
      'svc.auto.t': 'Workflow Automation',
      'svc.auto.d': 'Eliminate manual work with end-to-end automation: n8n workflows, webhooks, integrations, and AI-driven decision steps that connect every tool you use.',
      'svc.cca.t': 'Call Center Automation',
      'svc.cca.d': 'AI-powered call center automation: smart IVR, voice agents, ticket routing, sentiment-aware responses, and 24/7 multilingual customer support.',
      'svc.cloud.t': 'Cloud Architecture',
      'svc.cloud.d': 'Scalable, resilient infrastructure on AWS with Docker, Kubernetes, and CI/CD pipelines. Designed for performance, security, and cost-efficiency.',
      'svc.cto.t': 'CTO Advisory & PM',
      'svc.cto.d': 'Fractional CTO, technical due diligence, architecture reviews, hiring, and PMP-grade project management. From early-stage startups to enterprise programs.',
    ...
    ar: {
      ...
      'hero.pill': '💼 Backend Developer • AI Engineer • Data Engineer • CTO',
      'services.title': 'الخدمات اللي بقدمها',
      'services.desc': 'من أنظمة الـ Backend وخطوط بيانات Data Engineering لحد الـ AI Agents والأتمتة الذكية — اختار الخدمة اللي تناسب مشروعك.',

      'svc.backend.t': 'Backend Developer · مطوّر باك إند',
      'svc.backend.d': 'بناء REST APIs و Microservices و MVC backends عالية الأداء بـ Java و Spring Boot — مع Security و Performance و كود نضيف من أول يوم.',
      'svc.ai.t': 'AI Agents · وكلاء ذكاء اصطناعي',
      'svc.ai.d': 'AI Agents مخصّصة تتولّى دعم العملاء، متابعة المبيعات، العمليات الداخلية، ومعالجة المستندات — مبنية على Claude / OpenAI مع تنظيم n8n.',
      'svc.ml.t': 'Machine Learning · تعلم الآلة',
      'svc.ml.d': 'تدريب و تقييم و نشر نماذج Machine Learning للتنبّؤ، التصنيف، التوصيات، و كشف الشذوذ — بنشر إنتاجي عبر MLOps احترافي.',
      'svc.dl.t': 'Deep Learning · تعلم عميق',
      'svc.dl.d': 'حلول Deep Learning: Neural Networks و Computer Vision و NLP و نماذج Transformer — من PoC حتى خدمات استدلال (Inference) جاهزة للإنتاج.',
      'svc.de.t': 'Data Engineer · مهندس بيانات',
      'svc.de.d': 'هندسة بيانات شاملة: استيعاب، ETL pipelines، نمذجة بيانات، Data Warehousing، وتكامل موثوق بين SQL Server و NoSQL و أنظمة SaaS.',
      'svc.da.t': 'Data Analysis · تحليل البيانات',
      'svc.da.d': 'تحليل بيانات و Business Intelligence: تحويل البيانات الخام لأفكار تنفيذية بـ SQL و Python و Dashboards — KPIs و Cohort Analysis و أتمتة التقارير.',
      'svc.auto.t': 'Workflow Automation · أتمتة سير العمل',
      'svc.auto.d': 'تخلّص من الشغل اليدوي بأتمتة شاملة: n8n workflows و Webhooks و Integrations و خطوات قرار مبنية على AI تربط كل أدوات شركتك.',
      'svc.cca.t': 'Call Center Automation · أتمتة مراكز الاتصال',
      'svc.cca.d': 'أتمتة مراكز الاتصال بالذكاء الاصطناعي: IVR ذكي، Voice Agents، توجيه التذاكر، ردود تفهم المشاعر، و دعم عملاء متعدد اللغات على مدار 24/7.',
      'svc.cloud.t': 'Cloud Architecture · معمارية سحابية',
      'svc.cloud.d': 'بنية تحتية قابلة للتوسع و مرنة على AWS مع Docker و Kubernetes و CI/CD — مصمّمة للأداء و الأمان و كفاءة التكلفة.',
      'svc.cto.t': 'CTO Advisory · إدارة مشاريع',
      'svc.cto.d': 'CTO جزئي، Technical Due Diligence، مراجعات معمارية، توظيف، و إدارة مشاريع بمعايير PMP — من الستارت أب لحد برامج المؤسسات.',
